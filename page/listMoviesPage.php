...
solid #D40013; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    <div class="body d-flex justify-content-between">
        <h4>LIST MOVIE</h4>
        <h4><a href="../page/addMoviePage.php?" class="fa fa-plus-square-o" style="float: right; color: red; font-size:30px"></a> </h4>
    </div>
    <hr>
    <table class="table">
        <thead>
                ...
                while($data = mysqli_fetch_assoc($query)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            onClick="return confirm( \'Are you sure want edit this data?\')">
